"""Query parsing prompt — Claude Haiku turns NL search into structured filters.
...
PARSE_QUERY_TOOL: dict = {
    ...
    "description": "Parse a natural language HR search query into structured filters and a clean semantic search text.",
    "input_schema": {
        "type": "object",
        "properties": {
            "semantic_text": {
